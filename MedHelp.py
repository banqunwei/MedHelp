...
def get_list():
    url = 'https://www.medhelp.org/forums/Womens-Health-Postpartum/show/82'
...
def get_content(QuestionList):
    headers = {
        'Referer': 'https://www.medhelp.org/forums/Womens-Health-Postpartum/show/82',
...
def main():
    ...
    Question = []
    Answer = []
    for i in QuestionList[0:5]:
        q1, a1 = get_content(i)
        Question.append(q1)
        if a1:
            Answer.extend(a1)
    save_file(Question, 'MedHelp_Question.csv')
    save_file(Answer, 'MedHelp_Answer.csv')
